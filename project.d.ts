...
declare namespace gc {
  ...
  namespace model {
    class NrCellDU extends gc.sdk.GCObject {
      ...
      bwp: gc.model.BWP;
      userEquipments: gc.core.nodeList<gc.core.node<gc.model.UE>>;
      constructor(nRCellId: number | bigint, physicalCellId: number | bigint, nrCellCU: gc.core.node<gc.model.NrCellCU>, ssb: gc.model.SSB, policy: gc.model.CommunicationType, tdd: gc.model.TDD | null, bwp: gc.model.BWP, userEquipments: gc.core.nodeList<gc.core.node<gc.model.UE>>);
      static createFrom(fields: {nRCellId: number | bigint, physicalCellId: number | bigint, nrCellCU: gc.core.node<gc.model.NrCellCU>, ssb: gc.model.SSB, policy: gc.model.CommunicationType, tdd?: gc.model.TDD | null, bwp: gc.model.BWP, userEquipments: gc.core.nodeList<gc.core.node<gc.model.UE>>}): NrCellDU;
    }
    namespace NrCellDU {
      interface $Fields {
        nRCellId: 0;
  ...
  namespace api {
    class NetworkNodeItem extends gc.sdk.GCObject {
      ...
      label: string;
      group: string;
      gcNode: gc.core.node<any> | null;
      data: any | null;
      constructor(id: string, label: string, group: string, gcNode?: gc.core.node<any> | null, data?: any | null);
      static createFrom(fields: {id: string, label: string, group: string, gcNode?: gc.core.node<any> | null, data?: any | null}): NetworkNodeItem;
    }
    ...
    class getSignal$args extends gc.sdk.GCObject {
      static readonly _type = 'api::getSignal$args';
      static readonly $fields: getSignal$args.$Fields;
      nUE: gc.core.node<gc.model.UE>;
      constructor(nUE: gc.core.node<gc.model.UE>);
      static createFrom(fields: {nUE: gc.core.node<gc.model.UE>}): getSignal$args;
    }
    namespace getSignal$args {
      interface $Fields {
        nUE: 0;
      }
    }

    class SignalRecord extends gc.sdk.GCObject {
      static readonly _type = 'api::SignalRecord';
      static readonly $fields: SignalRecord.$Fields;
      t: gc.core.time;
      rsrp: number | bigint;
      rsrq: number;
      sinr: number;
      constructor(t: gc.core.time, rsrp: number | bigint, rsrq: number, sinr: number);
      static createFrom(fields: {t: gc.core.time, rsrp: number | bigint, rsrq: number, sinr: number}): SignalRecord;
    }
    ...
    class NetworkEdgeItem extends gc.sdk.GCObject {
      ...
      constructor(id: string, from: string, to: string, length: number | bigint);
      static createFrom(fields: {id: string, from: string, to: string, length: number | bigint}): NetworkEdgeItem;
    }
    ...
    function getSignal(nUE: gc.core.node<gc.model.UE>, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.core.Table<gc.api.SignalRecord> | null>;
  ...
  namespace sdk {
    interface GreyCat {
        ...
        call(method: 'api::getSignal', args: [gc.core.node<gc.model.UE>], signal?: globalThis.AbortSignal): Promise<gc.core.Table<gc.api.SignalRecord> | null>;
        spawn(method: 'api::getSignal', args: [gc.core.node<gc.model.UE>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::getSignal', args: [gc.core.node<gc.model.UE>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<gc.core.Table<gc.api.SignalRecord> | null>;
  ...
  interface $FieldsMap {
    ...
    'api::NetworkNodeItem::gcNode': 0,
    'api::NetworkNodeItem::data': 0,
    'api::getSignal$args::nUE': 0,
    'api::SignalRecord::t': 0,
    'api::SignalRecord::rsrp': 0,
    'api::SignalRecord::rsrq': 0,
    'api::SignalRecord::sinr': 0,
    'api::graphSnapshot$args::t': 0,
    'api::NetworkEdgeItem::id': 0,
    'api::NetworkEdgeItem::from': 0,
    'api::NetworkEdgeItem::to': 0,
    'api::NetworkEdgeItem::length': 0,
  ...
  export import SignalRecord = gc.api.SignalRecord;
  ...
  export import getSignal = gc.api.getSignal;
